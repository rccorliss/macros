#ifndef MACRO_FUN4ALLG4SPHENIXCMFLASH_C
#define MACRO_FUN4ALLG4SPHENIXCMFLASH_C
...
int Fun4All_G4_sPHENIX_CMFlash(
		       const int proc = 0,
		       const int nEvents = 5,
		       ...
		       const string &outdir = ".")
{
  ...
  if (Input::SIMPLE)
  {
    INPUTGENERATOR::SimpleEventGenerator[0]->add_particles("pi-", 100);
